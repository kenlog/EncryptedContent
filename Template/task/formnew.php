<h2><?= $form_headline ?></h2>
<small>
    <button id="randomKey" class="btn btn-blue" data-clipboard-text="<?= $this->EncryptedContentHelper->generateNewRandomKey() ?>" style="margin-bottom:10px"><?= t('Random key copy') ?></button>
    <button id="randomKey" class="btn btn-red" data-clipboard-text="<?= t('The key has been deleted from the clipboard') ?>" style="margin-bottom:10px"><?= t('Delete the key from the clipboard') ?></button>
